...
namespace ExtraFontInfo
{
	static const uint8_t FIXED_WIDTH_FONT_WIDTH[96] = {
	...
	static const uint8_t FIXED_WIDTH_FONT_DATA[96][6] = {
	  ...
	  {0x1c,0x22,0x2a,0x22,0x1e,0x00}, // 0
	...
	const blit::Font FIXED_WIDTH_FONT(&FIXED_WIDTH_FONT_DATA[0][0], FIXED_WIDTH_FONT_WIDTH, 6, 8);
